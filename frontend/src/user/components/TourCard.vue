...
<template>
  <router-link :to="'/tours/tour-detail/' + tour._id">
    <div class="relative">
      <div class="absolute top-5  -left-1 py-2 px-3 bg-orange-500 rounded-e-2xl text-white text-sm font-semibold">
        Đặc sắc
        <div class="absolute -bottom-1 left-0 border-l-[2px] border-r-[2px] border-b-[2px] border-t-[2px] border-transparent border-t-orange-700 border-r-orange-700"></div>
      </div>
      <div class="max-w-sm bg-white border border-gray-200 rounded-2xl shadow-3xl hover:shadow-full transition-shadow overflow-hidden">
        ...
        <div class="p-5 flex flex-col min-h-52">
          ...
          <p class="mb-2 font-normal text-gray-700 dark:text-gray-400">Thời lượng: <span>{{ tour.tourTime }}</span> giờ</p>
